...
PERMISSIONS = (
    ...
    "employees.audit.read employees.salary.read employees.salary.write employees.salary.manage "
    "employees.contracts.read employees.contracts.write employees.contracts.manage employees.alerts.manage "
    ...
    "projects.read projects.read_assigned projects.read_all projects.create projects.update projects.assign_people projects.assign_assets "
    "locations.read locations.manage "
    "maintenance.read maintenance.manage assets.read_assigned inventory.read inventory.read_assigned inventory.manage "
